...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: 'ZXCP的官方網站', // 英雄区文字
  STARTER_HERO_TITLE_2: '一款屬於台灣的遊戲正在準備中', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: 'Discord', // 英雄区按钮
  ...
  STARTER_BLOG_TITLE: 'PAGE',
  STARTER_BLOG_COUNT: 3, // 首页博文区块默认展示前3篇文章
  STARTER_BLOG_TEXT_1: '關於我們的事',
  STARTER_BLOG_TEXT_2:
    '這裡的東西都與我們相關',
  ...
  STARTER_CONTACT_LOCATION_TEXT: '台灣，Taiwan',
  STARTER_CONTACT_EMAIL_TITLE: '我们如何帮助您？',
  STARTER_CONTACT_EMAIL_TEXT: 'ZXCP',
