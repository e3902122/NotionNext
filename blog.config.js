...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZXCP', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ZXCP team', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zxcp.us.kg/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ZXCP, ROBLOX', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'e3902125@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=21233912.mp3',
      cover:
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '1962321', // 对应歌单的 id
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'ZXCP的官方網站', // 站点描述，被notion中的页面描述覆盖
